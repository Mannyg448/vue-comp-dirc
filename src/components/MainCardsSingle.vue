...
<style scoped lang="postcss">
  .card {
    @apply cursor-pointer overflow-hidden rounded-md bg-blue-500 p-8 shadow-md transition-transform duration-300 hover:scale-110 hover:shadow-2xl hover:shadow-slate-200;
    &-image {
      img {
    ...
    &-details {
      ...
      &-job {
        @apply -mt-2 text-xs font-bold text-blue-300;
      }
      &-quote {
        @apply pt-4 text-lg italic text-yellow-400;
      }
    }
  }
</style>